...
KEXEC_BOOT_PREREQS += device/samsung/jaspervzw/kexec-boot/kexec.sh
...
$(KEXEC_BOOT_OTA_PACKAGE_TARGET) : \
	...
	$(hide) ./device/samsung/jaspervzw/kexec-boot/ota_from_target_files -v \
	       -p $(HOST_OUT) \
	       --backup=false \
